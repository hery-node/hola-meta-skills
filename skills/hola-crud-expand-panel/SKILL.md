...
**Step 1:** Include in response but hide from table columns

```javascript
// hola-server/router/[entity].ts
// list: true - data IS returned in list response (needed for expand panel)
{ name: "description", type: "text", list: true, search: false }
```

**Step 2:** Hide from table columns and add to expand fields (client-side)

```vue
<!-- hola-web/src/views/[Entity]View.vue -->
<h-crud entity="product" :expand-fields="['description']" :hide-columns="['description']" :headers="headers">
</h-crud>
...
```javascript
// Server - list: true so data is returned
{ name: "description", type: "text", list: true }

// Client - hide from columns but show in expand panel
...
module.exports = init_router({
  ...
  fields: [
    ...
    // Include in response for expand panel (hide from columns on client)
    { name: "description", type: "text", list: true, search: false },
    { name: "specifications", type: "text", list: true, search: false },
  ],
});
```
...
```vue
<template>
  <h-crud entity="product" :sort-desc="[true]" :sort-key="['createdAt']" item-label-key="name" :expand-fields="expandFields" :hide-columns="expandFields" :headers="headers"> </h-crud>
</template>
...
fields: [
  ...
  { name: "description", type: "text", list: true },
  { name: "specifications", type: "text", list: true },
];
...
fields: [
  ...
  { name: "bio", type: "text", list: true },
  { name: "address", type: "text", list: true },
];
...
fields: [
  ...
  { name: "items", type: "array", list: true },
  { name: "shippingAddress", type: "text", list: true },
...
headers: [
  {
    ...
    expand: (item) => `
      <tr>
        ...
        <td>
          <table>
            ${(item.items || []).map((i) => `<tr><td>${i.name}</td><td>x${i.qty}</td><td>$${i.price}</td></tr>`).join("")}
          </table>
        </td>
      </tr>
    `,
...
| Task                     | Code                                                        |
| ------------------------ | ----------------------------------------------------------- |
| Include in list response | `{ name: "desc", type: "text", list: true }`                |
| Hide from table columns  | `:hide-columns="['desc']"`                                  |
| Add expand field         | `:expand-fields="['desc']"`                                 |
...
module.exports = init_router({
  ...
  fields: [
    ...
    // Expand panel fields
    { name: "summary", type: "text", list: true, search: false },
    { name: "content", type: "text", list: true, search: false },
    { name: "tags", type: "array:string", list: true },
    { name: "metadata", type: "object", list: true },
  ],
});
```
...
<template>
  <h-crud entity="article" item-label-key="title" :expand-fields="expandFields" :headers="headers"> </h-crud>
</template>
